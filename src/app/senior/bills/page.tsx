    ...
    <div className="relative min-h-screen flex flex-col overflow-x-hidden">
      ...
      <main className="relative z-10 flex-1 p-4 sm:p-6 max-w-4xl mx-auto w-full mb-24">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-2xl glass-surface-warm border border-emerald-300 text-emerald-900 font-extrabold text-sm sm:text-base">
            <ShieldCheck size={22} className="text-emerald-600" />
            <span>{t('GUARD_CAP')}</span>
          </div>
        </div>
